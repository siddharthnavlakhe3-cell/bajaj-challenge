package com.cfs.bajajchallenge.dto;
...
public class BfhlResponse {
    ...
    public String getConcat_string() { return concat_string; }
    public void setConcat_string(String concat_string) { this.concat_string = concat_string; }
}